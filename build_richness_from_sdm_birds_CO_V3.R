...
PRED_DIR <- "F:/SDM_project/results/SDM_birds/CO_ndvi_terrain_test/"
...
thr_csv <- file.path(OUT_DIR, "species_thresholds.csv")
utils::write.csv(thresholds, thr_csv, row.names = FALSE)
message("Saved thresholds table: ", thr_csv)

rich_tif <- file.path(OUT_DIR, "species_richness_birds_CO.tif")
